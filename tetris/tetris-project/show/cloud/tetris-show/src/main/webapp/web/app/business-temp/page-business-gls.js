 ...
 */
define([
    'text!' + window.APPPATH + 'bussiness-temp/page-bussiness-temp.html',
    'config',
    'jquery',
    'restfull',
    'context',
    ...
    'date',
    'mi-frame',
    'css!' + window.APPPATH + 'bussiness-temp/page-bussiness-temp.css'
], function(tpl, config, $, ajax, context, commons, Vue){

    var pageId = 'page-bussiness-temp';
        ...
        new Vue({
            ...
            methods:{
                rowEdit:function(scope){
                    ...
                    self.dialog.edittemp.ratio = row.ration;
