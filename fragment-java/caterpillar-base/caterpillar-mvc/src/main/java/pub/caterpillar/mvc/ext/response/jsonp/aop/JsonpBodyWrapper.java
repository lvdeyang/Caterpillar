package pub.caterpillar.mvc.ext.response.jsonp.aop;
...
import pub.caterpillar.mvc.ext.response.jsonp.exception.NoCallbackFoundForJsonpBodyException;
import pub.caterpillar.mvc.ext.response.jsonp.exception.NoRequestFoundForJsonpBodyException;
...
public class JsonpBodyWrapper {
	...
	//@Pointcut("(execution(public void *(..)) || execution(public java.lang.Object *(..))) && @annotation(pub.caterpillar.mvc.ext.response.jsonp.aop.annotation.JsonpBody)")
	@Pointcut("execution(public java.lang.Object *(..)) && @annotation(pub.caterpillar.mvc.ext.response.jsonp.aop.annotation.JsonpBody)")
