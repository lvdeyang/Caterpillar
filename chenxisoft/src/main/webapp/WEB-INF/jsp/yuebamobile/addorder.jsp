	...
	<script type="text/javascript">
	     $(function() {
		     ...
		     $(document).on('click','#save',function(){
		         var _urisavedo = window.BASEPATH + 'order/mobile/dosave';
		         var data={};
		         data.id=${worker.id};
		         data.fromDate=$('#fromDate').val();
		         $.post(_urisavedo, data, function(data){
				       location.href=window.BASEPATH +'worker/mobile/index?workerId=${worker.id}';
				 });
