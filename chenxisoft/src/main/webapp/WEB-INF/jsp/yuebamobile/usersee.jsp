	...
	<script type="text/javascript">
	     $(function() {
	          ...
	          function getPage(isinit){
	              var _uriWorker = window.BASEPATH + 'seerecord/mobile/seeworkerslist?currPage='+currPage+'&pageCount='+pageCount;
	          ...
	          function initList(data){
	               ...
	               if(data){
	                  for(var i=0;i<data.length;i++){
						    ...
						    html.push('        <span style="background-image:url(/'+data[i].workerPic+')"></span>');
						    html.push('    </div>');
