...
public class FaceEngineTest {
    ...
    public static void main(String[] args) {
        ...
        String appId = "CVRdMybZqzCKEpoV4zZawmcmSw7ugbpxeszgyUZMgcPS";
        String sdkKey = "FgXRZYj79ykz3fuUKr3F88ebsLeVWUErdD7s3z3kaGi";

        FaceEngine faceEngine = new FaceEngine("D:\\yuebacode\\chenxisoft\\src\\main\\webapp\\WEB-INF\\lib\\WIN64");
        //激活引擎
        ...
        //人脸检测
        ImageInfo imageInfo = getRGBData(new File("d:\\test1.jpg"));
        ...
        //人脸检测2
        ImageInfo imageInfo2 = getRGBData(new File("d:\\test6.jpg"));
        ...
        //IR属性处理
        ImageInfo imageInfoGray = getGrayData(new File("d:\\test3.jpg"));
