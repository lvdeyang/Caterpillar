...
require.config({
    ...
    paths: {
        ...
        'datatables-fixedColumns':window.LIBPATH + 'ui/datatables/extensions/FixedColumns/js/dataTables.fixedColumns',
        ...
        'alt-alert':window.COMMONSPATH + 'ui/admin-lte/alert/ui-alert',
        'alt-confirm':window.COMMONSPATH + 'ui/admin-lte/confirm/ui-confirm',
        ...
        'page-fleet':window.APPPATH + 'fleet/page-fleet',
        'page-driver':window.APPPATH + 'driver/page-driver',
        'page-car':window.APPPATH + 'car/page-car',
        'page-site':window.APPPATH + 'site/page-site',
        'page-route':window.APPPATH + 'route/page-route',
        'page-order':window.APPPATH + 'order/page-order',
        'page-system':window.APPPATH + 'system/page-system',
        'page-balance':window.APPPATH + 'balance/page-balance'
    ...
    shim:{
        ...
        'datatables-bootstrap':{
            deps: ['bootstrap', 'datatables-fixedColumns'],
            exports:'jQuery'
        },
...
require([
    ...
    var path = {
        ...
        commons:window.BASEPATH + window.COMMONSPATH
    };
