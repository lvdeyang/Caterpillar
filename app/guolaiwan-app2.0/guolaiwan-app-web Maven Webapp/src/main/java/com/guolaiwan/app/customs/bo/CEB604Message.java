...
// 生成时间: 2019.10.23 时间 02:46:10 PM CST 
//
 ...
 *                   &lt;element name="statisticsFlag" type="{http://www.w3.org/2001/XMLSchema}byte"/>
...
public class CEB604Message {

    @XmlElement(name = "InventoryReturn", namespace="http://www.chinaport.gov.cn/ceb")
    protected List<CEB604Message.InventoryReturn> inventoryReturn;
     ...
     * {@link CEB604Message.InventoryReturn }
     * 
     * 
     */
    public List<CEB604Message.InventoryReturn> getInventoryReturn() {
        if (inventoryReturn == null) {
            inventoryReturn = new ArrayList<CEB604Message.InventoryReturn>();
        }
