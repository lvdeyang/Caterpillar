...
public class LogisticController extends BaseController {
	...
	// 商家选取物流模块----获取物流的方法
	@ResponseBody
	@RequestMapping(value = "/getMerchantLogistics", method = RequestMethod.GET)
	public List<Map<String, Object>> getMerchantLogistics() throws Exception {
		List<LogisticsPo> findAll = conn_logistic.findAll();
		List<Map<String, Object>> list = new ArrayList<Map<String, Object>>();
		for (int i = 2; i < findAll.size(); i++) {
			Map<String, Object> hashMap = new HashMap<String, Object>();
			hashMap.put("id", findAll.get(i).getId());
			hashMap.put("name", findAll.get(i).getName());
			list.add(hashMap);
		}
		return list;
	}
