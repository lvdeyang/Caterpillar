package com.guolaiwan.app.web.admin.Utils;
...
public class LetvDownUrl {
	...
	public void setLetvUrl(String letvUrl) {
		this.letvUrl = letvUrl;
	}

	public  void letvDownUrl(String letvNumber) throws Exception {
		try{
		...
		reqData.put("video_id",letvNumber);
