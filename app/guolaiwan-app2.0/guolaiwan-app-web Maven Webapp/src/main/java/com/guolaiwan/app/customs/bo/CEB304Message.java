...
// 生成时间: 2019.10.21 时间 03:59:54 PM CST 
//
...
public class CEB304Message {

    @XmlElement(name = "OrderReturn", namespace="http://www.chinaport.gov.cn/ceb")
    protected List<CEB304Message.OrderReturn> orderReturn;
     ...
     * {@link CEB304Message.OrderReturn }
     * 
     * 
     */
    public List<CEB304Message.OrderReturn> getOrderReturn() {
        if (orderReturn == null) {
            orderReturn = new ArrayList<CEB304Message.OrderReturn>();
        }
