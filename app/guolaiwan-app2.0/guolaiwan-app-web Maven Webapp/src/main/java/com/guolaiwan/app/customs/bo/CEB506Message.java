...
// 生成时间: 2019.10.23 时间 01:50:55 PM CST 
//
...
public class CEB506Message {

    @XmlElement(name = "LogisticsReturn", namespace="http://www.chinaport.gov.cn/ceb")
    protected List<CEB506Message.LogisticsReturn> logisticsReturn;
     ...
     * {@link CEB506Message.LogisticsReturn }
     * 
     * 
     */
    public List<CEB506Message.LogisticsReturn> getLogisticsReturn() {
        if (logisticsReturn == null) {
            logisticsReturn = new ArrayList<CEB506Message.LogisticsReturn>();
        }
