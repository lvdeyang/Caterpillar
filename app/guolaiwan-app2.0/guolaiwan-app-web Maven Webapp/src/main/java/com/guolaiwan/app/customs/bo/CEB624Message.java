...
// 生成时间: 2019.10.25 时间 03:05:06 PM CST 
//
...
public class CEB624Message {
    ...
    protected List<CEB624Message.InvtCancelReturn> invtCancelReturn;
     ...
     * {@link CEB624Message.InvtCancelReturn }
     * 
     * 
     */
    public List<CEB624Message.InvtCancelReturn> getInvtCancelReturn() {
        if (invtCancelReturn == null) {
            invtCancelReturn = new ArrayList<CEB624Message.InvtCancelReturn>();
        }
