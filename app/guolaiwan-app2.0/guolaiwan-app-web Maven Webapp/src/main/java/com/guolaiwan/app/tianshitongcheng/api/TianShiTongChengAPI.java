...
public class TianShiTongChengAPI {
	 ...
	 * @return
	 */
	public static String sendPYLYPost(String orderId,String productId,String buynum,String buyUserName,String mobile,String startDate){
			Map<String, Object> paramsMap = new TreeMap<String, Object>(new Comparator<String>() {
			 ...
			 * 
			 * 1797248   
			 * b2d0b972bff1e34d0b602efbe49b4340  
