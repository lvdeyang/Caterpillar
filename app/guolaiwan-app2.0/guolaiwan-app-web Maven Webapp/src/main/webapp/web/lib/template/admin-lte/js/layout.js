/**
 * Created by lvdeyang on 2017/6/21.
 */
/**
 * AdminLTE Demo Menu
 * ------------------
...
define([
    ...
    function init_themeEditor(){
        ...
        demo_settings.append(
            ...
            + '<input id="develop-tools" type = "checkbox" data-layout = "fixed" class = "pull-right"/> '
            + '调试工具'
            + '</label>'
            + '</div>');
        ...
        demo_settings.append(
            ...
            + "全屏布局"
            + "</label>"
            + "<p style='font-size:12px;'>让全屏布局生效，不能与居中布局同时生效</p>"
            + "</div>"
                //Boxed layout
            + "<div class='form-group'>"
            + "<label class='control-sidebar-subheading'>"
            ...
            + "居中布局"
            + "</label>"
            + "<p style='font-size:12px;'>让居中布局生效</p>"
            + "</div>"
                //Sidebar Toggle
            + "<div class='form-group'>"
            + "<label class='control-sidebar-subheading'>"
            ...
            + "导航栏"
            + "</label>"
            + "<p style='font-size:12px;'>可以操控导航栏伸展收缩</p>"
            + "</div>"
            ...
            + "导航栏悬浮"
            + "</label>"
            + "<p style='font-size:12px;'>导航栏最小化时，有鼠标悬浮时导航栏展开</p>"
            + "</div>"
            ...
            + "工具栏占位"
            + "</label>"
            + "<p style='font-size:12px;'>可以操控工具栏伸展收缩时是否占位</p>"
            + "</div>"
            ...
            + "工具栏皮肤"
            + "</label>"
            + "<p style='font-size:12px;'>切换工具栏的皮肤</p>"
            + "</div>"
        );
    ...
    return{
        init_themeEditor:init_themeEditor,
