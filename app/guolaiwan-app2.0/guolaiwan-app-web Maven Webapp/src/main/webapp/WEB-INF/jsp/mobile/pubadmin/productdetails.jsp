		...
		$.get(_uriAddress, null, function(data){
			...
			if(data && data.length>0){
				...
				for(var i=0; i<data.length; i++){
			         ...
			         html.push('<h4 class="weui-media-box__title">'+data[i].consigneeName+'（'+data[i].consigneePhone+'）<span style="font-size:12px;color:red" class=" icon-share-alt">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;选择</span></h4>');
...
<body>
	<div id="page">
		...
		<div class="content">
		    ...
		    <a href="<%=basePath%>/pubnum/stock/index?productId=${id}" style="width:96%;margin-top:15px;margin-left:2%;background-color:#18b4ed;height:40px;line-height:40px;" href="javascript:;" class="weui-btn weui-btn_primary">预定管理</a>
