...
<body>
 <div class="nav" style="width:100%;height:auto;padding:0px 2%;margin:5px 0;border-radius:8px;">
  <ul style="">
   <li><span style="">请输入当前登录密码</span><input  placeholder="请输入当前登录密码" type="password"></li>
   <li><span style="">请输入新密码</span><input  placeholder="请输入新密码" type="password"></li>
   <li><span style="">确认新密码</span><input  placeholder="确认新密码" type="password"> </li>
  </ul>
 </div>
 <div class="main-in">
