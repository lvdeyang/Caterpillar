    ...
    <body>
        ...
        <div class="x-body">
            <xblock>
            	...
            	<button class="layui-btn" onclick="modularclass_add('添加模块','addv2','900','500')"><i class="layui-icon">&#xe608;</i>添加子模块</button>
        ...
        <script>
            layui.use(['element','laypage','layer','laytpl','table','form'], function(){
              ...
              table.on('tool(mClassList)',function(obj){
                 ...
                 if(obj.event === 'del'){
                    ...
                    modularclass_edit('编辑','updatev2',data.uuid,'','510');
                }else if(obj.event === 'question'){               
                  location.href = window.BASEPATH +'admin/base/questionText?uuid='+ data.uuid;
                }
            ...
            function modularclass_add(title,url,w,h){           
                x_admin_show(title,url+"?uuid=${uuid}",w,h);
            }
            //编辑
            ...
            function getClassList(){
                table.render({
                    ...
                    ,cols: [[
                        ...
                        , {title : '模块图片',align : 'center',templet : '#mktpTpl2'}     																			 
...
<script type="text/html" id="zsgc">
    ...
    <a title="添加问题" lay-event ="question"><i class="layui-icon">&#xe641;</i></a>
    </div>
</script>
