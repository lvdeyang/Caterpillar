...
<script type="text/javascript">
	...
	$(function() {
	  ...
	  var parseAjaxResult = function(data){
		...
		//获取所有一级推荐
      var _uriProduct = window.BASEPATH + 'pubnum/getMerchantPro?code=${code}';
			    ...
			    var pros=data;
				   ...
				   for(var i=0;i<pros.length;i++){
				       if(i%2==0){
		                 ...
		                 html.push('<image style=" width:100%;height:100px;" src="'+pros[i].productShowPic+'" class="product" id="pro-'+pros[i].id+'"/>');
		                 html.push('<p style="font-size:12px">'+pros[i].productName+'￥'+pros[i].productPrice+'</p>');
		                 html.push('</td>');
	                     if(pros.length==1){
	                       html.push('<td style="padding:10px;width:50%"><div style="width:100%;height:100px;"></div></td>');
	                     }
	                  if(i%2==1){
				          html.push('</tr>');
				      }
		...
		$(document).on('click','.product',function(){
	       ...
	       location.href=window.BASEPATH + 'pubnum/merproduct/index/'+codes[1];
