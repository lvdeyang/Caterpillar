	...
	$(function() {
		...
		$(document).on('click', '.btn', function() {
			...
			if ($(".input1").val().search(re)) {
				...
				window.location.href="vice//merchant/smartparking";
			}
		...
		<div class="main">
			<div class="main1" style="border-bottom:1px solid #CCCCCC;">
				<img class="img4"
					...
					style="width:200px;height:30px;line-height: 30px;border:none;outline:none;"
			...
			<div class="main2" style="border-bottom:1px solid #CCCCCC">
				<img class="img3"
					...
					style="height:30px;line-height: 30px;width: 202px;border: 0;outline: none; >
