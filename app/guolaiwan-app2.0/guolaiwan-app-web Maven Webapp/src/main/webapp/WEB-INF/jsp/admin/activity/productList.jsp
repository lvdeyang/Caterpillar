...
<div class="x-body">
	<xblock>
		<button class="layui-btn" onclick="show_win('添加商品','bdPro?acId=${activity.id}','1000','700')"><i class="layui-icon">&#xe608;</i>添加</button>
		<button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>清空</button>
		<span class="x-right" style="line-height:40px">参与该活动的商品有：<span id="account"></span>个</span>
