			...
			$.get(_uriQuery, null, function(data){
			    ...
			    if(data && data.length>0){
			       ...
			       for(var i=0;i<data.length;i++){
					   ...
					   html.push('<h4 style="width:50%;float:left" class="weui-media-box__title">'+data[i].name+'</h4><h4 style="width:25%;float:right" class="weui-media-box__title">￥'+data[i].price+'</h4>');
					   html.push('<p style="width:100%;height:15px" class="weui-media-box__desc">'+data[i].name+'</p>');
					   html.push('<p style="width:100%" class="weui-media-box__desc"><div style="float:right;margin-right:25px;font-size:12px;">采购</div></p>');
					   html.push('</div>');
					   html.push('</a>');
			       
			       }
			       $('#proList').append(html.join(''));
			    }
...
<body>
	<div id="page">
		...
		<div class="content">
			...
			<div id="proList" class="weui-panel__bd">
