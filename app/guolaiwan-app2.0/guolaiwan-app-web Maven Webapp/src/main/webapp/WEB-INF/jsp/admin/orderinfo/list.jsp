...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a><cite>首页</cite></a> <a><cite>订单信息</cite></a>
	...
	<div class="x-body">
		...
		<div class="layui-inline">
			...
			订单号：
			<div class="layui-inline">
				<input class="layui-input" name="orderNO" id="orderNO"
					autocomplete="off">
			</div>
		...
		<div class="layui-inline">
			...
			商品：
			<div class="layui-inline">
				<input class="layui-input" name="pName" id="pName"
					autocomplete="off">
			</div>

			<button class="layui-btn" data-type="reload"
				onclick="selectPName(this)">模糊搜索</button>
			<button type="button" class="layui-btn" id="deriveallorder"
				onclick="deriveallorder()">导出所有订单</button>
			<div class="layui-inline">
				<from class="layui-form">
				<table>
					<td><select class="lay-input-inline" name="pmenus"
						lay-verify="required" id="pmenus">
					...
					<td>
						<button class="layui-btn" data-type="reload"
							onclick="fenyefind(this)">查询</button>
					</td>
				</table>
				</from>
			</div>
		...
		<div class="layui-tab layui-tab-brief" lay-filter="demo">
			<ul class="layui-tab-title">
				<li class="layui-this">未付款<span id="NOTPAYbadge"
					class="layui-badge"></span></li>
				<li>已付款<span id="PAYSUCCESSbadge" class="layui-badge"></span></li>
				<li>已发货（商城）<span id="DELIVERbadge" hidden="hidden"
					class="layui-badge"></span></li>
				<li>已收货（商城）<span id="RECEIPTbadge" hidden="hidden"
					class="layui-badge"></span></li>
				<li>已确认（订餐）<span id="CONFIRMEDbadge" hidden="hidden"
					class="layui-badge"></span></li>
				<li>已验单（景点）<span id="TESTEDbadge" hidden="hidden"
					class="layui-badge"></span></li>
				<li>已评价<span id="COMMENTEDbadge" hidden="hidden"
					class="layui-badge"></span></li>
				<li>申请退款<span id="REFUNDINGbadge" hidden="hidden"
					class="layui-badge"></span></li>
				<li>退款成功<span id="REFUNDEDbadge" hidden="hidden"
					class="layui-badge"></span></li>
				<li>退款失败<span id="REFUNDFAILbadge" hidden="hidden"
					class="layui-badge"></span></li>
			</ul>
