      ...
      var _uriRecomment = window.BASEPATH + 'phoneApp/activityInfo?productId=${id}&userId=${userId}';
		...
		function initpeopleList(){
		   ...
		   for(var i=0;i<count;i++){
			    ...
			    html.push('<p style="position: absolute;top:132px;left:10%;">填写身份证</p>');
			    html.push('<img id="face" style="width:25px;height:25px;position: absolute;right:5%;top:132px;" src="lib/images/zhaoxiang.png"');
			    html.push('</li>');
			    html.push('</ul>');
			    html.push('</div>');
			    html.push('<div style="background:#fff;height:300px;width:96%;border-radius:6px;margin:0 auto;position: relative;top:25px;">');
			    html.push('<p style="margin-left:8%;height:50px;line-height: 50px;">人脸拍摄</p>');
			    html.push('<img style="width:180px;height:180px;position: absolute;left:50%;margin:10px 0 0 -90px;opacity: 0.6" alt="" class="uploadImages" id="uploadImage-'+i+'"  src="lib/images/renlian2s.png">');
