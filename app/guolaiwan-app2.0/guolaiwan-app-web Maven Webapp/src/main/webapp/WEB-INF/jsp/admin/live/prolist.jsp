...
<script>
  ...
  function addToDistribute(id , carid,cla){
     ...
     $.ajax({
          	  type:"get",
     			  url:"<%=basePath%>admin/live/selectPro.do/"+id+"/"+carid+"/"+cla,
                  data:{},
...
function getList(){
	if('${classify}'=='PRODUCT')
	{
	  table.render({               
	    elem:'#productList'
	    ,method:'post'
	    ,url:'<%=basePath%>admin/live/proList.do'
	    ,page:true
	    ,limits: [10,30,50,100]
	    ,limit: 10
	    ,skin:'row'
	  ...
	  table.render({               
	    elem:'#productList'
	    ,method:'post'
	    ,url:'<%=basePath%>admin/live/merList.do'
	    ,page:true
	    ,limits: [10,30,50,100]
	    ,limit: 10
	    ,skin:'row'
	    ...
	    elem:'#productList'
	    ,method:'post'
	    ,url:'<%=basePath%>admin/live/actList.do'
	    ,page:true
	    ,limits: [10,30,50,100]
	    ,limit: 10
	    ,skin:'row'
...
function getProductListByf(data){
   ...
   elem:'#productList'
   ,method:'post'
   ,url:'<%=basePath%>admin/live/mohuSelect.do'
   ,where:data
   ,page:true
   ,skin:'row'
   ,even:true
