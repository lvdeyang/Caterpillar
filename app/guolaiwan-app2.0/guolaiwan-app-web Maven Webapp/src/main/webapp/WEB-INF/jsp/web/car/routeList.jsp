    ...
    <div class="pc-info fr">
        ...
        <div class="time-border-list pc-search-list clearfix">
            <ul class="clearfix" id="productList">
            	<c:forEach items="${routes}" var="rs">
            		<li>
                    	<a href="productInfo?info=${rs.uuid}"> <img width="209px" height="140px" src="${sysConfig.webUrl}"></a>
                    	<p class="head-name"><a href="productInfo?info=${rs.uuid}">${rs.lab}</a> </p>
                    	<p><span class="price">￥${rs.uuid}</span></p>
                    	<p class="head-futi clearfix"><span class="fl">好评度：90% </span> <span class="fr">人购买</span></p>
