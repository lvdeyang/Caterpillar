...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            <xblock><button class="layui-btn" onclick="open_win('添加打卡点','addv','1000','600')"><i class="layui-icon">&#xe608;</i>添加打卡点</button><span class="x-right" style="line-height:40px">共有数据：<span id="allcount"></span> 条</span></xblock>
