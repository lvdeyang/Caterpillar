...
<script type="text/javascript">
	...
	$(function() {
	    function getList(){
	        ...
	        var _uriQuery = window.BASEPATH + 'distributor/order/list/${distributorId}';
			...
			$.get(_uriQuery, null, function(data){
			    ...
			    if(data && data.length>0){
			       ...
			       for(var i=0;i<data.length;i++){
			           var html=[];
				       html.push('<a href="'+window.BASEPATH + 'distributor/order/info/'+data[i].id+'"');
	...
	<div id="page">
		...
		<div class="header">
			<div class="wrapper">
				...
				<div class="header-content">采购订单</div>
			</div>
		</div>
		<div class="content">
