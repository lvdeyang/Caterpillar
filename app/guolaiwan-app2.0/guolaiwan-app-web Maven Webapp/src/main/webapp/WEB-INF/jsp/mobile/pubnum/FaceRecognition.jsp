			...
			$.post(_uriYd, $.toJSON(params), function(data){
				...
				if(data){
				    ...
				    if(data=='TESTED'){
				       ...
				       $.toast("验单通过");
                       succeed(data.orderId,data.userid);
				       setTimeout(function(){
...
function succeed(orderNo){
	   var _uriYd = window.BASEPATH + 'pubnum/succeed';	   	       
	   var params={};
      params.orderNo=orderNo;
