 ...
 $(function(){
  ...
  function getRecomment(){
     ...
     $.get(_uricoms, null, function(msg){    
       ...
       htm.push('<span style="float:right;margin-right:5px;color:#EB6E1E;font-size:18px;font-weight:bold;">￥'+prouctMessage[0].price+'</span>');
       htm.push('</p>');
    ...
    //套餐票
    if(isCombo==1){
     location.href=window.BASEPATH + 'product/package/payment/jump?merchantId=${merchantId}&proId='+activeId+'&choice=1&comboId='+id+'&isCombo='+isCombo;
    }
    //原票
    else{    
     location.href=window.BASEPATH + 'product/package/payment/jump?merchantId=${merchantId}&proId='+id+'&choice=1&isCombo='+isCombo; 
    }          
    }
