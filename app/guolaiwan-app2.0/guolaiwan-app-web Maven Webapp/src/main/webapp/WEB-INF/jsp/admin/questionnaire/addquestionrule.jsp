...
<html>
    ...
    <body>
        ...
        <div class="x-body" style="height:1500px">
            <form class="layui-form layui-form-pane">
 				  <div class="layui-form-item">
                    <label for="questionrule" class="layui-form-label">
 						问卷规则：
                    </label>
                    <div class="layui-input-block">
                        <textarea name="questionrule"  placeholder="请输入内容" class="layui-input" id="questionrule" style="height:300px">${questionnairerole}</textarea>
                    </div>
                </div>
                
            	<input type="hidden" name="questionnaireId" value="${questionnaireId}" class="layui-input">
                <div class="layui-form-item">
        ...
        <script>
         ...
         //实例化编辑器
    		var um = UM.getEditor('questionrule');
           ...
           function add(data,message){
                ...
                $.ajax({
                	  type:"post",
           			  url:"<%=request.getContextPath() %>/admin/questionnaire/addquestionrule",
                      data:data.field,
