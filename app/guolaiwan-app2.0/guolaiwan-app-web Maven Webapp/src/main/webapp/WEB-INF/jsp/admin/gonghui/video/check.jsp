		...
		<form class="layui-form layui-form-pane">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<img style="width:300px;height:200px" src="${webPath}/${video.contractPicUrl}"/>
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<video style="width:300px;height:200px" src="${webPath}/${video.contractUrl}" autoplay controls="controlss"/>
				</div>
			</div>
