...
<div class="x-body">
	<xblock>
		<button class="layui-btn" onclick="show_win('添加商品','bdPro?supersellId=${supersell.id}','1000','700')"><i class="layui-icon">&#xe608;</i>添加</button>
		<button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>清空</button>
		<span class="x-right" style="line-height:40px">参与该卖场的商品有：<span id="account"></span>个</span>
...
<script type="text/html" id="zsgc">
	...
	<a class="layui-btn layui-btn-xs" lay-event="del">不参与卖场</a>
	<a class="layui-btn layui-btn-xs" onclick="product_info('修改','update.do/','{{ d.id }}','','510')">修改</a>
</script>
