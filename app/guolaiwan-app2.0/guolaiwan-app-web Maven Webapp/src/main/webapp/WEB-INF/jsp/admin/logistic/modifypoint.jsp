    ...
    <body>
        <div class="x-body" style="height:1500px">
            <form class="layui-form layui-form-pane">
            	<input name="uuid" type="hidden" value="${point.id}">
                <div class="layui-form-item">
                	<div class="layui-inline">
                    	...
                    	<div class="layui-input-inline">
                        	...
                        	autocomplete="off" class="layui-input" value="${point.name}">
                    	</div>
                    </div>
 				</div>
 				...
 				<div class="layui-form-item">
					...
					<div class="layui-input-inline" style="width: 100px;">
						<input type="text"  name="longitude" id="longitude"  autocomplete="off" class="layui-input" value="${point.longitude}">
					</div>
					<div class="layui-form-mid">-</div>
					<label for="L_title" class="layui-form-label"> 纬度 ：</label>
      				<div class="layui-input-inline" style="width: 100px;">
						<input type="text" name="latitude" id="latitude"  autocomplete="off" class="layui-input" value="${point.latitude}">
					</div>
					<div class="layui-input-inline" style="width: 100px;">
