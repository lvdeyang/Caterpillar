    ...
    <body>
        ...
        <div class="x-body">
            <xblock>
            	...
            	<button class="layui-btn" onclick="modularclass_add('添加问题','addproblem','900','500')"><i class="layui-icon">&#xe608;</i>添加问题</button>
            ...
            layui.use(['element','laypage','layer','laytpl','table','form'], function(){
              ...
              table.on('tool(mClassList)',function(obj){
                 ...
                 if(obj.event === 'del'){
                    ...
                    modularclass_edit('编辑','upCommPro',data.uuid,'','510');
                }                
              })
...
<script type="text/html" id="switchTpl">
  <input type="checkbox" name="classIsv" id='{{d.id}}' value="{{d.className}}" lay-skin="switch" lay-text="是|否" lay-filter="classIsv" {{ d.isView == 1 ? 'checked' : '' }}>
</script>
    </body>
</html>