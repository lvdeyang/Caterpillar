...
<div class="nav">
   ...
   <div style="height:70px;width:88%;display: inline-block;padding:0 2%;vertical-align:middle;position: relative; font-size:90%;">
     <input id="nav_s" placeholder="人名/集会名称" style="width:60%;height:30px;padding:0 0 0 6%;text-align:center;margin-top:10px;border-radius:6px;border:none;outline:none;border:1px solid #fff;background-color: rgba(0,0,0,0.0)">
...
<div class="main" style="width:100%;height:auto;margin-top:-50px;">
  ...
  <div class="main_in" style="">
   <p style="text-align: center;line-height: 35px;font-size:150%;">集会名称：<span>xxx</span></p>
   ...
   <div style="width:78%;height:auto;display: inline-block;">
    <ul style="line-height: 25px;font-size:80%;">
     <li><p>参会人姓名：<span>xxx</span></p></li>
     <li><p>参会人身份证号：<span>130281xxxxxxxxxxxx</span></p></li>
     <li><p>集会开始时间：<span>2019年9月10日</span><span>10：02：00</span></p></li>
     <li><p>集会结束时间：<span>2019年9月10日</span><span>10：02：00</span></p></li>
     <li><p>集会地点：<span>xxx</span></p></li>
     <li><p>集会人数：<span>110人</span></p></li>
