...
.layui-table img{     max-width: 1000px;}/* 照片的最大宽度  */
    ...
    <body>
        ...
        <div class="x-body">
            ...
            <xblock><button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button><button class="layui-btn" onclick="addCarousel()"><i class="layui-icon">&#xe608;</i>添加图片</button><span class="x-right" style="line-height:40px">共有数据：<span id="allcount"></span> 条</span></xblock>
        ...
        //是否显示
              form.on('switch(enable)', function(obj){
                ...
                layer.tips("id:"+this.value+' : '+str,obj.othis);
              });
              return false;
         ...
         function getcarouselList(){
            table.render({
              ...
              ,cols: [[
                ...
                ,{field: 'comName' ,title: '显示位置',sort: true,width:200}
                ,{title: '是否显示',templet:"#switchTpl",width:100}
              
              
                
                
                ,{title: '操作',sort: true,templet:'#zsgcTpl',width:160}
              ]]
...
<script type="text/html" id="switchTpl">
	<input type="checkbox" name="enable" id="{{d.id}}" value={{d.id}} lay-skin="switch" lay-text="on|off" lay-filter="enable" {{ d.enable == 1 ? 'checked' : '' }} >
</script>
