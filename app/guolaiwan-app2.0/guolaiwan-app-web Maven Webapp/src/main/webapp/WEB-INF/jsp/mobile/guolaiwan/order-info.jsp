...
<body>
<form enctype="multipart/form-data" id="distributor-form" action="<%=basePath%>distributor/apply" method="POST">
	<div id="page">
		<!-- 主页 -->
		<div class="header">
			<div class="wrapper">
		...
		<div class="content">
			...
			<div class="weui-cells weui-cells_form">
				...
				<div style="width:100%;height:100px;background:#18b4ed;color:#FFF;text-align:center">
				...
				<c:if test="${order.status=='CHECKED'}">
				 ...
				 <c:if test="${order.status=='NOTPASSED'}"> 
				       审核未通过
				       <br><br><span style="font-size:12px;">${order.rejectReason}</span>
				  </c:if>
...
/* 			$.post(_uricancelOrder,null, function(data){
