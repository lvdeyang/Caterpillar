    ...
    <body>
        <div class="x-body" style="height:1500px">
            <form class="layui-form layui-form-pane">
            	<input type="hidden" name="lanId" value="${oneLanList.id}" />
                <div class="layui-form-item">
                	<div class="layui-inline">
                    	...
                    	<div class="layui-input-inline">
                        	<input type="text" id="lanName" name="lanName" required lay-verify="required"
                        	autocomplete="off" class="layui-input" value="${oneLanList.name}">
                    	</div>
                    </div>
 				</div>
 				<div class="layui-form-item">
