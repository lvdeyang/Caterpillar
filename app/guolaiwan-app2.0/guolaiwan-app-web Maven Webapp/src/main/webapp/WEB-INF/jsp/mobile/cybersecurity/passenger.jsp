...
<div class="nav"> 
    ...
    发车时间：
       <input style="background-color: rgba(0,0,0,0.0);border:none;width:15% !important;text-align: left;font-size:90% !important;" type="text" class="layui-input" id="test14" placeholder="选择时间">
   班次：
   <select style="background-color: rgba(0,0,0,0.0);border:none;outline:none;line-height: 30px;height:30px;">
    <option>205</option>
    <option>224</option>
   </select>
   <div style="height:70px;width:88%;display: inline-block;padding:0 2%;vertical-align:middle;position: relative; font-size:90%;">
     <input id="nav_s" placeholder="人名/客运公司" style="width:60%;height:30px;padding:0 0 0 6%;text-align:center;margin-top:10px;border-radius:6px;border:none;outline:none;border:1px solid #fff;background-color: rgba(0,0,0,0.0);">
