...
<script type="text/javascript">
	...
	$(function() {
	  ...
	  $(document).on('click','#save',function(){
		    var _uriAdd = window.BASEPATH + 'distributor/offorder/add';
			/*if($('#address').val()==''){
			...
			var params={};
			params.proId=${proId};
			params.address=$('#moreAddress').val();
	...
	<div id="page">
		...
		<div class="header">
			<div class="wrapper">
				...
				<div class="header-content">编辑线下订单</div>
			</div>
		</div>
		<div class="content">
			...
			<div class="weui-cells weui-cells_form">
			  ...
			  <!-- <div class="weui-cell">
		        <div class="weui-cell__hd"><label for="name" class="weui-label">地址选择</label></div>
		        <div class="weui-cell__bd" style="border:1px solid #CCC">
		          <input class="weui-input" id="address" type="text" value="" readonly="" data-code="420106" data-codes="420000,420100,420106">
		        </div>
		      </div> -->
			  ...
			  <div class="weui-cell">
			    ...
			    <div class="weui-cell__bd" style="border:1px solid #CCC">
			      <input id="moreAddress" class="weui-input" type="text" placeholder="">
			    </div>
			  </div>
			</div>
