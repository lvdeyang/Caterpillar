...
<body>
	...
	<div class="x-body">
		...
		<span class="x-right lheight4">共有 ${count} 个分销商</span></xblock>
		<table class="layui-table" id="distributorList"
			lay-filter="distributorList"></table>
 ...
 <a title="审核" href="javascript:;" onclick="distributor_check('审核','toCheck.do','{{ d.id }}','','510')"
