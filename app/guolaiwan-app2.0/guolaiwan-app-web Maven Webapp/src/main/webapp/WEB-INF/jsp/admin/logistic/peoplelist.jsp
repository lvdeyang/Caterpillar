...
<div class="x-nav">
	...
	<div class="x-body">
		...
		<button class="layui-btn"
			onclick="full_show('添加快递员','peopleaddv?pId=${pId}','1000','800')">
...
{{#  layui.each(d.list, function(index, item){ }}
                        ...
                        <td class="td-manage">
						 <a title="修改" href="javascript:;" onclick="people_edit('编辑','peopleupdatev','{{ item.id }}','','510')" 
                            style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>     
                       <a title="删除" href="javascript:;" onclick="people_del(this,'{{ item.id }}')" 
                            style="text-decoration:none">
                                <i class="layui-icon">&#xe640;</i>
                            </a>
                        </td>               
...
{{#  } }} 
	...
	function people_add(title,url,w,h){
    ...
    //讲解点编辑
    function people_edit(title,url,id,w,h){
    	x_admin_show(title,url+"?pId="+pId+"&uuid="+id,w,h); 
    }
