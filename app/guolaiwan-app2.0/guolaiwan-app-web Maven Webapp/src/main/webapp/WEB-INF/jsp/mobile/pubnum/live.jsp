...
<script type="text/javascript">
	...
	$(function() {
	  ...
	  var parseAjaxResult = function(data){
		...
		function getLive(page){
		    var _urilive = window.BASEPATH + 'phoneApp/getLiveList?liveType=USER';
		  
			$.get(_urilive, null, function(data){
				...
				if(data){
				   ...
				   generatePersons(pros);
	
				}
			});
			
			var _uriliveMerchant = window.BASEPATH + 'phoneApp/getLiveList?liveType=MERCHANT';
		  
			$.get(_uriliveMerchant, null, function(data){
				data = parseAjaxResult(data);
				if(data === -1) return;
				if(data){
		 		...
		 		var pros=data;
				   for(var i=0;i<pros.length;i++){
				       if(i%2==0){
		                 ...
		                 html.push('<image style=" width:100%;height:170px;" src="'+pros[i].cover+'" class="live" id="live-'+pros[i].id+'"/>');
		                 html.push('<p style="font-size:12px;text-align:center">'+pros[i].liveName+'</p>');
		                 html.push('</td>');
	                     if(pros.length==1){
				   ...
				   $('#person_table').append(html.join(''));
		}
		function generateMerchants(data){
		           var html=[];
		           var pros=data;
				   for(var i=0;i<pros.length;i++){
				       if(i%2==0){
	    ...
	    $(document).on('click','.live',function(){
	       ...
	       location.href=window.BASEPATH + 'pubnum/liveplay?id='+ids[1];
	    });
	...
	<div id="page">
		...
		<div class="header">
			<div class="wrapper">
				...
				<div class="header-content">直播</div>
			</div>
		</div>
		<div class="content">
			...
			<div class="weui-search-bar" id="searchBar" style="display:none">
			  <div class="weui-search-bar__form">
			    <div class="weui-search-bar__box">
			      ...
			      <input type="search" class="weui-search-bar__input" id="searchInput" placeholder="搜索" required="" value="${content}">
			...
			<div class="weui-tab">
             ...
             <div class="weui-tab__bd">
			    ...
			    <div id="tab2" class="weui-tab__bd-item">
                    ...
                    <table id="person_table" style="margin-top:15px;">
