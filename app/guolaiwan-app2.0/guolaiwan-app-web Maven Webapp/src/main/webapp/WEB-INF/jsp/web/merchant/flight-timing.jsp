	...
	<div class="containers clearfix">
	    <div class="pc-info fr">
	    	<div class="pc-term" style="height:40px; font-size:15px; font-weight:700; text-align:center; line-height:40px;">
            	<span>班次：</span><span>${route.origin}</span> —— <span>${route.end}</span>
            </div>
	        <div class="pc-term tab" style="margin-bottom:0; height:40px; border-bottom:0;">
                <a href="<%= path%>/web/merchant/query/flight/${merchant.uuid}/${route.uuid}/CARTIME?pagecurr=1" class="active">班次</a>
                <a href="<%= path%>/web/merchant/query/flight/${merchant.uuid}/${route.uuid}/CONTRACT?pagecurr=1">包车</a>
            </div>
