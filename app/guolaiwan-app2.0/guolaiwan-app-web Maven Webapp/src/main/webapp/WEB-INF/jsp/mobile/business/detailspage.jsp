...
<body>
	   ...
	   <p style="font-szie:12px;background: #EFEFEF;width:100%;height:30px;line-height:30px;margin:0;text-align: center;font-weight:bold;">商品详情</p>
	   <div class="xiang" style="padding:10px 10% 0;text-indent:2em;height:auto;background: #EFEFEF;">
