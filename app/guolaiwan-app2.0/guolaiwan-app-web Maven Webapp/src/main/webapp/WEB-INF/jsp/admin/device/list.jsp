...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            <xblock><button class="layui-btn" onclick="open_win('添加设备','addv','600','500')"><i class="layui-icon">&#xe608;</i>添加设备</button><span class="x-right" style="line-height:40px">共有数据：<span id="allcount"></span> 条</span></xblock>
	         	...
	         	table.render({
            		...
            		,limit: 10
   					,cols: [[
   						...
   						,{field:"deviceCode",title:"设备标识",edit:"text"}
	...
	function del(id){
		layer.confirm("真的要删除么？",function(index){
          ...
          <script type="text/html" id="zsgc">
			<a class='layui-btn layui-btn-primary layui-btn-xs' href="javascript:open_win('选择商户','<%=path%>/admin/device/selMerchantv?id={{ d.id }}','1200','500')">选择商户</a>
