            ...
            <form class="layui-form layui-form-pane">
 				<div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        autocomplete="off" class="layui-input" value="${questiontitle}">
                    </div>
                </div>
                <div class="layui-form-item">
				    <label class="layui-form-label">问题类型 </label>
				    <div class="layui-input-block">
				      <input type="radio" name="questiontype" value="1" id="one" title="单选">
				      <input type="radio" name="questiontype" value="2" id="two" title="多选">
				      <input type="radio" name="questiontype" value="3" id="bool" title="判断" >
				    </div>
				</div>
                <div class="layui-form-item">
                	<input type="hidden" id="options" name="options"
                        autocomplete="off" class="layui-input" value="${options}">
                    <label for="options1" class="layui-form-label">
                                                           A(对)
                    </label>
                    <div class="layui-input-block">
                        <input type="text" id="options1" name="options1" required lay-verify="required"
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="options2" name="options2" required lay-verify="required"
                        autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        autocomplete="off" class="layui-input" value="${answer}">
                    </div>
                </div>
                <input type="text" id="questionId" name="questionId" hidden="hidden" value="${questionId}">
				<div id="view"></div> 
        ...
        <script>
        	layui.use([ 'form', 'layer','laytpl' ], function() {
              ...
              for(var i=0;i<options.length;i++){
                 var input=$('input[name="options'+(i+1)+'"]');
                 input.val(options[i]);
              }
