...
<div class="nav">
   ...
   <div style="height:70px;width:88%;display: inline-block;padding:0 2%;vertical-align:middle;position: relative; font-size:90%;">
     <input id="nav_s" placeholder="人名/景区/住宿/物流/客运/集会" style="width:60%;height:30px;padding:0 0 0 6%;text-align:center;margin-top:10px;border-radius:6px;border:none;outline:none;border:1px solid #fff;background-color: rgba(0,0,0,0.0)">
