...
<body>
<form enctype="multipart/form-data" id="distributor-form" method="POST">
	<div id="page">
		<!-- 主页 -->
		<div class="header">
			<div class="wrapper">
			...
			<div class="weui-cells weui-cells_form">
				<div class="weui-cell">
					<div class="weui-cell__hd">
						<label class="weui-label">分销商品</label>
					</div>
					<div class="weui-cell__bd">
						<input value="${order.name }" class="weui-input" type="text" placeholder="">
					</div>
				</div>
				<div class="weui-cell">
					<div class="weui-cell__hd">
					...
					<div class="weui-cell__bd">
						<input value="${order.region }" class="weui-input" type="text"
							placeholder="">
					</div>
				</div>
				...
				<div class="weui-cell">
					<div class="weui-cell__hd">
						<label class="weui-label">分销数量</label>
					</div>
					<div class="weui-cell__bd">
						<input value="${order.count }" class="weui-input" type="text"
							placeholder="">
					</div>
				</div>
				...
				<div class="weui-cell">
					<div class="weui-cell__hd">
						<label class="weui-label">分销价格</label>
					</div>
					<div class="weui-cell__bd">
						<input value="${order.price }" class="weui-input" type="text" 
							placeholder="">
					</div>
				</div>
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input value="${order.applicationDate }" class="weui-input" type="text" 
				...
				<div class="weui-cell">
					<div class="weui-cell__hd">
						<label class="weui-label">审核详细</label>
					</div>
					<div class="weui-cell__bd">
						<input id="checkMsg" class="weui-input" type="text" 
							placeholder="">
					</div>
				</div>
				
				<div class="weui-cells__title">上传合同:</div>
				<div style="width:100%;height:100px;">
					
					
					<image src="${order.contractPicUrl }" id="showContractPic" style="margin-left:15px;width:100px;height:100px;"/>
						
					
					
				</div>
				
				<div class="weui-cells__title">上传合同视频:</div>
				<div style="width:100%;height:100px;">
...
<script type="text/javascript">
	$(function() {
	    ...
	    $(document).on('click','#reject',function(){
	       checkOrder("NOTPASSED");
	    });
	    function checkOrder(status){
	        var _uriCheckOrder = window.BASEPATH + 'distributor/order/doCheck';
		    var params={};
		    params.id=${order.id};
		    params.status=status;
		    params.reason=$('#checkMsg').val();
			$.post(_uriCheckOrder, $.toJSON(params), function(data){
				data = parseAjaxResult(data);
				if(data === -1) return;
			    if(data){
			       location.href=window.BASEPATH + 'distributor/selladminorder/index';
			    }
