...
<script type="text/javascript">
	$(function() {
		...
		var _uriModal = window.BASEPATH + 'phoneApp/getShare/'+${shareId};
		$.get(_uriModal, null, function(data) {
			...
			html.push('<image class="modal" style="width:75%;height:25%" src="http://<%=weburl%>/guolaiwan/lib/images/jingdian.jpg"/>');
			html.push('<div>' + data.data.proName + '</div>');

			html.push('</td>');
			html.push('<td>');
			
			html.push('<image class="modal" style="width:75%;height:25%" src="http://<%=weburl%>/guolaiwan/lib/images/tianqi.jpg"/>');
			html.push('<div>' + data.data.weather + '℃</div>');

			html.push('</td>');
			html.push('<td>');
			
			html.push('<image class="modal" style="width:75%;height:25%" src="http://<%=weburl%>/guolaiwan/lib/images/jiaoyin.jpg"/>');
			html.push('<div>' + data.data.step + '步</div>');

			html.push('</td>');
			html.push('<td>');
			
			html.push('<image class="modal" style="width:75%;height:25%" src="http://<%=weburl%>/guolaiwan/lib/images/kaluli.jpg"/>');
			html.push('<div>' + data.data.calorie + '大卡</div>');

			html.push('</td>');
			html.push('<td>');
			
			html.push('<image class="modal" style="width:75%;height:25%" src="http://<%=weburl%>/guolaiwan/lib/images/km.jpg"/>');
			html.push('<div>' + data.data.km + 'km</div>');
		...
		function generateProduct(data) {
			for (var i = 0; i < data.childList.length; i++) {
				...
				html.push('<span style="font-weight: bold;">'+data.childList[i].childName+'↓</span>');
				html.push("</div>");
				html.push('<br />');
				html.push('<div style="text-align: center;">');
				html.push('<image class="modal" style="width:90%;height:50%" src="http://<%=weburl%>/guolaiwan'+data.childList[i].childPic+'">');
				html.push("</div>");
				html.push('<div style="text-align: center;">');
				html.push('<span style="color: black;font-size: 12px;">'+data.childList[i].content+'</span>');
				html.push("</div>");
				html.push('<br />');
...
<body>
	...
	<table id="geturl" style="margin-top:15px;"></table>
	<div style="text-align: center;">
		<span style="color: green;font-size: 25px">旅行小计</span>
	</div>
	<table id="columnTable" style="margin-top:15px;"></table>
	<br />
	<div style="text-align: center;" id="jiaoyin">
