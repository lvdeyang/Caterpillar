...
.layui-table img{     max-width: 1000px;}/* 照片的最大宽度  */
    ...
    <body>
        ...
        <div class="x-body">
            ...
            <xblock><button class="layui-btn" onclick="addadvertisement()"><i class="layui-icon">&#xe608;</i>添加广告图</button><span class="x-right" style="line-height:40px">共有数据：<span id="allcount"></span> 条</span></xblock>
            <table id='advertisementList' lay-filter='advertisementList' ></table>
        ...
        <script>
            ...
            layui.use(['element','laypage','layer','laytpl','table','form'], function(){
              ...
              getadvertisementList();
               ...
               //编辑
        table.on('edit(advertisementList)',function(obj){
        	layer.load();
        	var data = obj.data
        	,field = obj.field
        	,value = obj.value;
        ...
        //是否显示
         ...
         function getadvertisementList(){
            table.render({
              elem:'#advertisementList'
              ,method:'post'
              ,url:'advertisementList.do'
              ,page:true
              ,limits: [10,30,50,100]
              ,limit: 10
              ,cols: [[
...
<script type="text/html" id="zsgcTpl">
	...
	<a class='layui-btn layui-btn-xs' href="javascript:open_win('选择图片','<%=path%>/admin/picture/addlist?sImg=caImg{{d.id}}&sId={{ d.id }}&source=live','600','500')">选择图片</a>
	<a class='layui-btn layui-btn-danger layui-btn-xs' href="javascript:advertisement_del(this,'{{ d.id }}')">删除</a>		
