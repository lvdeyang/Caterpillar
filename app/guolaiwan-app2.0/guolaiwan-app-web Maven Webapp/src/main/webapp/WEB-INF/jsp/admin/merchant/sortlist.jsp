...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text"  id="city" lay-verify="title" autocomplete="off" placeholder="请输入标题" class="layui-input" value="${merchant.comName}">
    </div>
    
     <label class="layui-form-label">商品名称</label>
    <div class="layui-input-block">
      <input type="text"  id="city" lay-verify="title" autocomplete="off" placeholder="请输入标题" class="layui-input" value="${merchant.shopName}">
    </div>

    
    <label class="layui-form-label">所属板块</label>
    <div class="layui-input-block">
      <input type="text" id="modular" lay-verify="title" autocomplete="off" placeholder="请输入标题" class="layui-input" value="${merchant.modularName}">
    </div>
	...
	<script> 
        ...
        function sortChange(){ 
          $.ajax({
                    ...
                    data:{"id":${merchant.id},
                          "state":state,
                          "modularCode":"${merchant.modularCode}"
                         },
