...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a><cite>首页</cite></a> <a href="<%=path%>/merchant/route/list"><cite>路线</cite></a>
			<a><cite>班次</cite></a>
	...
	<div class="x-body"> 
		...
		<button class="layui-btn"
			onclick="driver_add('添加包车','addv?route=${route}&type=contract','600','500')">
			<i class="layui-icon">&#xe608;</i>添加包车
		</button>
		<button class="layui-btn"
			onclick="driver_add('添加班次','addv?route=${route}&type=cartime','600','500')">
			<i class="layui-icon">&#xe608;</i>添加班次
		</button>
...
{{#  layui.each(d.list, function(index, item){ }}
                        ...
                        <td class="td-manage">
                         	<a title="编辑" href="javascript:;" onclick="driver_edit('编辑','updatev','{{ item.uuid }}','600','500')"
