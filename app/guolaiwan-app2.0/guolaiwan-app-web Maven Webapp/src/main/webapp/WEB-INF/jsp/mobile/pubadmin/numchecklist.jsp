	...
	<div id="page">
		...
		<div class="header">
			<div class="wrapper">
				...
				<div class="header-content">订单号验单</div>
			</div>
		</div>
		<div class="content">
			...
			<div class="weui-cells weui-cells_form">
			  <div class="weui-cell">
			    ...
			    <div class="weui-cell__bd" style="border:1px solid #CCC">
			      <input id="num" class="weui-input" type="text" placeholder="">
			    </div>
			  </div>
			
			
			<div style="width:100%;height:55px;"></div>
			<a id="checklist" style="width:96%;margin-left:2%;background-color:#18b4ed;height:40px;line-height:40px;" href="javascript:;" class="weui-btn weui-btn_primary">验单</a>
