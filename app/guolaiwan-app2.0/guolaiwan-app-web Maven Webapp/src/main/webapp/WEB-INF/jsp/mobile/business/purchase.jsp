	       ...
	       //后面的
                ...
                var pro_pro = list[i].productName.split(",");                               
		         ...
		         if(pro_pro[1] == "act"){
		          ...
		          html.push('<p style="font-size:12px;"><span style="color:#EC6D1E;font-size:16px;float:left;margin:10px 0 0 2%;">￥'+str[i]+'</span><span style="float:left;text-decoration: line-through;font-size:90%;color:#515151;margin:14px 0 0 5px; ">100</span><span style="float:right;margin-top:12px">已售'+data.marketList[i]+'+</span><span style="color:#EC6D1E;float:right;margin-top:12px;">'+grade[i]+'分</span>   </p>');
