...
<body>
    <div class="content">
	    ...
	    <image src="lib/images/card/card3.png" style="width:100%;height:150px;"/>
	    <div style="width:96%;margin-left:2%;">遵化市文化旅游惠民年卡全域版</div>
	    <div style="width:96%;margin-left:2%;color:#CCC;font-size:12px">此卡含清东陵、万佛园以及遵化周边各个景区，所含景区 全年不限次使用</div>
	    <image src="lib/images/card/info3.png" style="width:100%;"/>
