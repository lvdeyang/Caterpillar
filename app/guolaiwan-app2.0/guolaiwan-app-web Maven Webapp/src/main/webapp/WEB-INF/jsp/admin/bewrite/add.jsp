            ...
            <form class="layui-form layui-form-pane">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id="L_title" name="url" required lay-verify="required"
                        autocomplete="off" class="layui-input">
                    </div>
                </div>
            	<input type="hidden" name="imgId" value="${picId}">
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea name="miaoshu"  placeholder="请输入内容" class="layui-input" id="describeCon" style="height:300px"></textarea>
                    </div>
