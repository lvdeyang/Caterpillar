...
html.push('<p style="transform:rotate(-45deg);height:25px;background: #2BAD4A;color:#fff;position: absolute;width:100%;left:-55px;top:5px;line-height:25px;text-align: center;font-size:110%">折扣</p>');
html.push('</div>');
}
