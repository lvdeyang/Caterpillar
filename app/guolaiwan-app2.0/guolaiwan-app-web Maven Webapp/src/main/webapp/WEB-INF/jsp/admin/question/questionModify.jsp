                ...
                <div class="layui-form-item">
                	<div class="layui-inline">
                    	...
                    	<div class="layui-input-inline">
                        	...
                        	autocomplete="off" class="layui-input" value="${Problem.problemName}">
                    	</div>
                	</div>					
 				</div>
				 ...
				 <div class="layui-form-item">
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							...
							lay-verify="title" autocomplete="off" class="layui-input" readonly="readonly" value="${Problem.modularClassName}">
							<input type="text" id="L_title" name="modularCode" 
							lay-verify="title" autocomplete="off" class="layui-input" style="display: none" value="${Problem.modularClassCode}">							
						</div>
					</div>				
				</div> 
               ...
               <div class="layui-form-item">
               	<div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="${Problem.sort}">
                 	</div>
                 </div>
 				...
 				<div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea name="productIntroduce"  placeholder="请输入内容" class="layui-input" id="productIntroduce" style="height:300px">${Problem.problemdescribe}</textarea>
                    </div>
                </div>
         ...
         //实例化编辑器
           ...
           function renderForm(){
              ...
              form.on('submit(add)', function(data){
                ...
                $.ajax({
                	  type:"post",
           			  url:"upProblem.do?uuid=${Problem.uuid}",
                      data:data.field,
