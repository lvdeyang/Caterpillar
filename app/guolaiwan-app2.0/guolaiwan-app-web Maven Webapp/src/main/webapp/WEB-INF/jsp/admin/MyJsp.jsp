  ...
  <div class="layui-layout layui-layout-admin">
    <div class="layui-header header header-demo">
     ...
     <ul class="layui-nav" lay-filter="">
      <li class="layui-nav-item"> <a href="javascript:;">${adminName}</a>
        <dl class="layui-nav-child">
          <!-- 二级菜单 -->
          <dd><a href="">个人信息</a></dd>
          <dd><a href="">切换帐号</a></dd>
          <dd><a href="<%= request.getContextPath() %>/do/logout">退出</a></dd>
        </dl>
      </li>
      <li class="layui-nav-item x-index"><a href="http://<%=weburl%>">前台首页</a></li>
    </ul>
  </div>
  <div style='position: absolute;left:400px;top:35%;color:#C5C5C5'>${comName}</div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','#mims',function(){
