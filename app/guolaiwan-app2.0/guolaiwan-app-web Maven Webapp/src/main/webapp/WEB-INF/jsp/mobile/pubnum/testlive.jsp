...
<script type="text/javascript">
	...
	$(function() {
      ...
      $(document).on('click','#stoplive',function(){
           var urlStop = window.BASEPATH + '/fishtest/stop';
		  
			$.get(urlStop, null, function(data){
      ...
      $(document).on('click','.switchm',function(){
           var ids=this.id.split('-');
           switchm(ids[1]);
      })
      

		function switchm(proNo){
		    var urlSwitch = window.BASEPATH + '/fishtest/switchm?proNo='+proNo;
		  
			$.get(urlSwitch, null, function(data){
				data = parseAjaxResult(data);
				if(data === -1) return;
				if(data){
...
<body>
	<div id="page">
		...
		<div class="content">
			...
			<a href="javascript:void(0);" id="switchm-1" class="switchm">切换线路1</a>
		    <a href="javascript:void(0);" id="switchm-2" class="switchm">切换线路2</a>
		    <a href="javascript:void(0);" id="stoplive">停止播放</a>
		</div>
	</div>
</body>
