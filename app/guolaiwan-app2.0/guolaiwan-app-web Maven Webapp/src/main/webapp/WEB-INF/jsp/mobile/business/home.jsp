	...
	<div class="content" id="content" >
	 ...
	 <!-- 分类  -->
	  <div  style="background:#fff;width:96%;height:230px;margin:0 auto;z-index:1;border-top-left-radius: 10px;border-top-right-radius: 10px;top:12px;position: relative;overflow: hidden;">
	     ...
	     <input class="inp" placeholder="关键字/词" style="float:right;margin-top:15px;margin-right:5%;width:35%;height:30px;border:none;outline: none;padding:10px 0 10px 9%;border-radius:16px;background:#EEEEEE;clear: both;" onfocus="search()"></input>	     
