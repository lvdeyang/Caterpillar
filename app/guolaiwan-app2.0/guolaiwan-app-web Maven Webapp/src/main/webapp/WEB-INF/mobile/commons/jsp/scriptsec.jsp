...
<script type="text/javascript">
    ...
    $(function() {
		...
		if(href.indexOf('supersell')==-1){
			...
			//+str);
			$('.header-content').html('<span id="headerName" style="font-size:14px">'+nameHeader+'</span><div id="phone" style="font-size:10px;position:absolute;margin-top:-38px;z-index:1000;right:10px">'+phone+'</div>'
			+str);
