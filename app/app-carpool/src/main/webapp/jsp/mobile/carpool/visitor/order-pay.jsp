	...
	<div id="page">
    	...
    	<div class="weui-form-preview">
			...
			<div class="weui-form-preview__ft">
				...
				<form action="<%=basePath %>order/prev/pay/${order.id}" method="POST" id="pay-order-form"></form>
			    <button class="weui-form-preview__btn weui-form-preview__btn_default" id="order-cancel">取消</button>
			    <button class="weui-form-preview__btn weui-form-preview__btn_primary" id="order-pay">支付</button>
			</div>
		</div>
	</div>
