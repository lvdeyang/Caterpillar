			...
			<div class="weui-panel__bd">
				<a href="javascript:void(0);"
					...
					<div class="weui-media-box__hd">
						<img style="width:100%;height:100%" class="weui-media-box__thumb"
							src="/image/1.jpg"
							alt="">
					</div>
					<div class="weui-media-box__bd">
						<h4 style="width:50%;float:left" class="weui-media-box__title">清东陵</h4><h4 style="width:25%;float:right" class="weui-media-box__title">$140</h4>
						<p style="width:100%;height:15px" class="weui-media-box__desc">由各种物质组成的巨型球状天体，叫做星球。星球有一定的形状，有自己的运行轨道。</p>
						<p style="width:100%" class="weui-media-box__desc"><div style="float:right;margin-right:25px;">采购</div></p>
					</div>
				</a> 
				<a href="javascript:void(0);"
					class="weui-media-box weui-media-box_appmsg">
