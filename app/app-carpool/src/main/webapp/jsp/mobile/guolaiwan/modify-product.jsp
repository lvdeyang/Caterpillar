...
<body>
	<div id="page">
		...
		<div class="content">
		   <image style="width:100%;height:200px;" src="/image/uxinhualufang200112.jpg"/>
		   <div style="font-size:12px;padding-left:10px;font-weight:bold"><清东陵景区></div>
			<div class="weui-cells weui-cells_form" style="font-size:12px;">
                ...
                <div class="weui-cells__title">分销套餐设置<a class="weui-btn weui-btn_mini weui-btn_primary" href="javascript:void(0)" style="float:right;font-size:12px;margin-right:5px;">添加</a></div>
           
             <div class="weui-cells__title">10000个/50元（个）<a class="weui-btn weui-btn_warn weui-btn_mini weui-btn_primary" href="javascript:void(0)" style="float:right;font-size:12px;margin-right:5px;">删除</a></div>
           
             <div class="weui-cells__title">20000个/40元（个）<a class="weui-btn weui-btn_warn weui-btn_mini weui-btn_primary" href="javascript:void(0)" style="float:right;font-size:12px;margin-right:5px;">删除</a></div>
           
            
			
				<a style="position:fixed;bottom:0;width:96%;margin-left:2%;background-color:#18b4ed;height:40px;line-height:40px;" href="javascript:;" class="weui-btn weui-btn_primary">申请</a>
			</div>
		</div>
	</div>
	<!-- 订单提交表单 -->
