			...
			<div class="weui-tab">
				<div class="weui-navbar" style="height:40px;line-height:14px;">
					<a class="weui-navbar__item weui-bar__item--on" href="#tab1">
						全部商品 </a> <a class="weui-navbar__item" href="#tab2"> 已上架 </a>
				</div>
				<div class="weui-tab__bd">
					<div id="tab1" class="weui-tab__bd-item weui-tab__bd-item--active">
                         <table id="product_table">
                                <tr><td>
                                  <image class="proImage" src="/image/uxinhualufang200112.jpg"/>
                                  <p><清东陵景区通票></p>
                                  <div class="operation">
                                  <a href="javascript:void(0)">修改</a>|<a href="javascript:void(0)">上架</a>|<a href="javascript:void(0)">下架</a>|<a href="javascript:void(0)">删除</a>
                                  </div>
                                </td><td><image class="proImage" src="/image/uxinhualufang200112.jpg"/>
                                  <p><清东陵景区通票></p>
                                  <div class="operation">
                                  <a href="javascript:void(0)">修改</a>|<a href="javascript:void(0)">上架</a>|<a href="javascript:void(0)">下架</a>|<a href="javascript:void(0)">删除</a>
                                  </div>
