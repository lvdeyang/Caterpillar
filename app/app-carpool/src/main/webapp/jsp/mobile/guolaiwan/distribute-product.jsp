...
<body>
	<div id="page">
		...
		<div class="content">
		    <image style="width:100%;height:150px;" src="/image/1.jpg"/>
			<div class="message">景区地址：河北省唐山市遵化市</div>
			<div class="message">开放时间：8:00-17:00</div>
			<div class="message">客服电话：0315-6685662</div>
			<div id="regionBar">购买须知</div>
			<div class="message" style="font-size:16px">请选择您要分销的地区</div>
			<div class="message" style="margin-top:0">
				<div style="width:80px;float:left;height:44px;line-height:44px;text-align:left">地区选择：</div>
            ...
            <div class="message" style="margin-top:0">
				<div style="width:80px;float:left;height:44px;line-height:44px;">购票数量：</div>
            	...
            	<div style="width:100px;;float:left;height:44px;line-height:44px;">单价：120元</div>
            </div>
		</div>
		
	
		<a style="width:96%;margin-left:2%;background-color:#18b4ed;height:40px;line-height:40px;" href="javascript:;" class="weui-btn weui-btn_primary">申请分销</a>
	</div>
	<!-- 订单提交表单 -->
