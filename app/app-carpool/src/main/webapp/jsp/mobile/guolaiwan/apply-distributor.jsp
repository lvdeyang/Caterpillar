	...
	<div id="page">
		...
		<div class="content">
			...
			<div class="weui-cells weui-cells_form">
				...
				<div class="weui-cells__title">上传营业执照</div>
				...
				<a style="width:96%;margin-left:2%;background-color:#18b4ed;height:40px;line-height:40px;" href="javascript:;" class="weui-btn weui-btn_primary">申请</a>
			</div>
		</div>
	</div>
	<!-- 订单提交表单 -->
