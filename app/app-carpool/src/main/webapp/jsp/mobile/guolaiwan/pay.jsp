...
<body>
	<div id="page">
		...
		<div class="content">
		    <div style="width:100%;height:50px;padding-left:20px;line-height:50px;">清东陵景区</div>
			<div style="width:100%;height:220px;background:#CCC;padding:20px;">
			     <div class="orderMsg" style="background:#FFF;width:100%;height:100%;border-radius:5px">
			          <div style="border-bottom:1px solid #CCC;height:40px;line-height:40px;font-size:14px;margin-left:15px;"><清东陵景区通票（包含电瓶车）></div>
			          <p>订单号:20180919</p>
			          <p>购票数量:10000</p>
			          <p>景区电话:0315-6669520</p>
			          <p>入库信息:王双双 13810728953</p>
			     </div>
			</div>
			<div style="width:100%;height:30px;line-height:30px;padding-left:15px;font-size:12px;">自付金额<span style="color:red">￥650000</span> 请选择以下支付方式支付</div>
		    ...
		    <div style="position:fixed;bottom:0px;width:100%;height:40px;line-height:40px;font-size:14px;padding-left:15px;">支付总额:<span style="color:red">$65000</span>
		    
		        <a href="javascript:;" style="float:right;margin-right:15px;" class="weui-btn weui-btn_mini weui-btn_primary">支付</a>
		    </div>
