...
<%
	...
	String libPath = "web/lib/";
	String appPath = "web/app/";
	String projectPath = "web/app/console/";
%>
...
<head>
	...
	<!-- commons -->
    <link rel="stylesheet" type="text/css" href="<%=basePath %><%=appPath %>commons/commons.css" />
...
<script type="text/javascript" src="<%=basePath %><%=libPath %>frame/requireJS/require.js"  defer async="true" data-main="<%=basePath %><%=projectPath %>main"></script>
