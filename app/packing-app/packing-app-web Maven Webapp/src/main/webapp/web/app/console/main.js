...
require.config({
    ...
    paths: {
        ...
        'context':window.APPPATH + 'spa/context',
        'page':window.APPPATH + 'spa/page',

        'date':window.APPPATH + 'commons/date/date.ext',
        'string':window.APPPATH + 'commons/string/string.ext',
        'storage':window.APPPATH + 'commons/storage/storage.ext',
        'restfull':window.APPPATH + 'commons/restfull/restfull.api',
        'datatables-zkCN':window.APPPATH + 'commons/ui/admin-lte/datatables/ui-datatables-lang-zhCN',

        'tree':window.APPPATH + 'commons/ui/custom/tree/js/tree',

        'alt-loader':window.APPPATH + 'commons/ui/admin-lte/loader/ui-loader',
        'alt-messenger':window.APPPATH + 'commons/ui/admin-lte/messenger/ui-messenger',
        'alt-modal':window.APPPATH + 'commons/ui/admin-lte/modal/ui-modal',
        'alt-select':window.APPPATH + 'commons/ui/admin-lte/select/normal/ui-select',
        'alt-tree-select':window.APPPATH + 'commons/ui/admin-lte/select/tree/ui-tree-select',
        'alt-switch-select':window.APPPATH + 'commons/ui/admin-lte/select/switch/ui-switch-select',
        'alt-spinner':window.APPPATH + 'commons/ui/admin-lte/input/spinner/ui-spinner',
        'alt-checkbox':window.APPPATH + 'commons/ui/admin-lte/checkbox/ui-checkbox',
        'alt-tab':window.APPPATH + 'commons/ui/admin-lte/tab/ui-tab',

        'commons':window.APPPATH + 'commons/commons',

        'html-header':window.PROJECTPATH + 'component/header.html',
        'html-sidebar':window.PROJECTPATH + 'component/sidebar.html',
        'html-foot':window.PROJECTPATH + 'component/foot.html',
        'html-rightbar':window.PROJECTPATH + 'component/rightbar.html',
        'html-content-header':window.PROJECTPATH + 'component/content-header.html',

        'page-error':window.PROJECTPATH + 'error/page-error',
        'page-home':window.PROJECTPATH + 'home/page-home',

        //挪车服务
        'page-packing-user':window.PROJECTPATH + 'packing/user/page-packing-user',
        'page-packing-qr':window.PROJECTPATH + 'packing/qr/page-packing-qr',

        //管理员
        'page-admin':window.PROJECTPATH + 'admin/page-admin',

        //权限管理
        'page-auth-authority':window.PROJECTPATH + 'auth/authority/page-auth-authority',
        'page-auth-role':window.PROJECTPATH + 'auth/role/page-auth-role'
